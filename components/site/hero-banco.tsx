      ...
      <div className="mx-auto max-w-7xl px-5 md:px-10">
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="relative mx-auto w-full max-w-[420px] lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:max-w-none lg:self-center">
            {/* brilho decorativo atrás do vídeo */}
            <div className="absolute -inset-3 -z-10 rounded-[2rem] bg-gradient-to-br from-primary/30 via-primary/10 to-transparent blur-2xl" />
            ...
            <div className="relative mx-auto aspect-[9/16] w-full max-w-[420px] overflow-hidden rounded-3xl bg-muted shadow-2xl ring-1 ring-black/5">
              ...
              {/* overlay com botão de play custom, some quando toca */}
              {!isPlaying && (
                <button
                  onClick={handlePlay}
            ...
            {/* selo flutuante */}
            <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 rounded-full bg-card px-4 py-1.5 text-xs font-semibold text-ink shadow-lg ring-1 ring-black/5">
              Mobilidade com Liberdade
            </div>
