export function Cta() {
  return (
    <section id="contato" className="relative overflow-hidden bg-primary py-16 text-primary-foreground md:py-24">
      <div className="mx-auto max-w-4xl px-5 text-center md:px-10">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-pretty text-base opacity-90 md:text-lg">
          Não adie mais o seu sonho de liberdade. Nossa equipe está pronta para desenhar o projeto
          ideal para a sua nova vida.
        </p>
